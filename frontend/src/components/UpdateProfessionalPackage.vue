<template>
    ...
    <div class="update-service-package">
      <h2 class="form-title">Update Service Package</h2>
        ...
        <div class="card-body text-center">
            <form @submit.prevent="updateService">
              ...
              <div class="form-group">
                ...
                <input type="number" v-model="form.price" required class="form-control" />
              </div>
  
              <br>
  
              <div class="form-group">
                <label for="time_required" class="form-label">Time Required(in days):</label>
  ...
  export default {
    ...
    methods: {
      fetchPackageDetails() {
        ...
        fetch(`http://localhost:8000/api/professional/service_packages/${pkgId}`,{
          headers:{
      ...
      updateService() {
        ...
        fetch(`http://localhost:8000/api/professional/update_service_package/${pkgId}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
            'Authorization':`Bearer ${token}`
